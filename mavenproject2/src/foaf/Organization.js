...
Organization = function(rdf) {
    ...
    queryObject(rdf, "?Organization", "foaf:comment", "?comment")
        .each(function() {
    ...
    var label = new Array();
    queryObject(rdf, "?Organization", "foaf:label", "?label")
        .each(function() {
    ...
    queryObject(rdf, "?Organization", "foaf:member", "?member")
        .each(function() {
    ...
    var type = new Array();
    queryObject(rdf, "?Organization", "foaf:type", "?type")
        .each(function() {
...
Organization.prototype = new Agent();
