...
SpatialThing = function(rdf) {
    ...
    queryObject(rdf, "?SpatialThing", "foaf:Basednear", "?Basednear")
        .each(function() {
    ...
    queryObject(rdf, "?SpatialThing", "foaf:comment", "?comment")
        .each(function() {
            comment.push(new SpatialThing(rdf
    ...
    var label = new Array();
    queryObject(rdf, "?SpatialThing", "foaf:label", "?label")
        .each(function() {
            label.push(new SpatialThing(rdf
    ...
    queryObject(rdf, "?SpatialThing", "foaf:member", "?member")
        .each(function() {
            member.push(new SpatialThing(rdf
    ...
    var type = new Array();
    queryObject(rdf, "?SpatialThing", "foaf:type", "?type")
        .each(function() {
            type.push(new SpatialThing(rdf
...
SpatialThing.prototype = new Thing();
