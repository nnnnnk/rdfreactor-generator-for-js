...
LabelProperty = function(rdf) {
    ...
    queryObject(rdf, "?LabelProperty", "foaf:comment", "?comment")
        .each(function() {
    ...
    var label = new Array();
    queryObject(rdf, "?LabelProperty", "foaf:label", "?label")
        .each(function() {
    ...
    queryObject(rdf, "?LabelProperty", "foaf:member", "?member")
        .each(function() {
    ...
    var type = new Array();
    queryObject(rdf, "?LabelProperty", "foaf:type", "?type")
        .each(function() {
...
LabelProperty.prototype = new Thing();
