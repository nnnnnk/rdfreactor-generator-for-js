...
Project = function(rdf) {
    ...
    queryObject(rdf, "?Project", "foaf:comment", "?comment")
        .each(function() {
    ...
    var label = new Array();
    queryObject(rdf, "?Project", "foaf:label", "?label")
        .each(function() {
    ...
    queryObject(rdf, "?Project", "foaf:member", "?member")
        .each(function() {
    ...
    var type = new Array();
    queryObject(rdf, "?Project", "foaf:type", "?type")
        .each(function() {
